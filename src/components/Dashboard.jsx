...
import { LineChart, Line, Area, BarChart, Bar, XAxis, YAxis, Tooltip, Legend, ResponsiveContainer, ReferenceLine } from "recharts";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: S.xl }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: S.md }}>
        {[
          ...
          <div key={s.label} className="card-interactive" onClick={s.onClick} style={{ background: C.card, border: `1px solid ${s.accent}25`, borderRadius: R.xl, padding: `${S.lg}px ${S.xl}px`, boxShadow: SH.glow(s.accent), display: "flex", flexDirection: "column", justifyContent: "space-between", height: 88, boxSizing: "border-box", cursor: s.onClick ? "pointer" : "default" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: S.md }}>
        ...
        <button className="card-interactive" onClick={onNewSession} style={{ background: `linear-gradient(135deg, ${C.blue}50, ${C.purple}60)`, border: `1px solid ${C.purple}40`, borderRadius: R.xl, padding: `${S.lg}px ${S.xl}px`, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between", height: 88, boxSizing: "border-box", boxShadow: SH.glow(C.purple), transition: "all 0.15s ease", textAlign: "left" }} onMouseEnter={(e) => { e.currentTarget.style.boxShadow = SH.glow(C.blue); }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = SH.glow(C.purple); }}>
          <div style={{ fontSize: 10, color: C.text2, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>Registrar</div>
          <div style={{ fontSize: 28, fontWeight: 900, color: C.blue, fontFamily: FN, lineHeight: 1, whiteSpace: "nowrap" }}>+ Sessão</div>
        </button>
        <button className="card-interactive" onClick={onAlerts} style={{ background: `linear-gradient(135deg, ${C.red}45, ${C.purple}50)`, border: `1px solid ${C.red}35`, borderRadius: R.xl, padding: `${S.lg}px ${S.xl}px`, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between", height: 88, boxSizing: "border-box", boxShadow: SH.glow(C.red), transition: "all 0.15s ease", textAlign: "left" }} onMouseEnter={(e) => { e.currentTarget.style.boxShadow = SH.glow(C.purple); }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = SH.glow(C.red); }}>
          ...
          <div style={{ fontSize: 32, fontWeight: 900, color: C.red, fontFamily: FN, lineHeight: 1 }}>GAPS</div>
        </button>
      </div>
