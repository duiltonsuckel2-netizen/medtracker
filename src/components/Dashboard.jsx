    ...
    <div style={{ display: "flex", flexDirection: "column", gap: S.xl }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: S.md }}>
        {[
          ...
          <div key={s.label} className="card-interactive" style={{ background: C.card, border: `1px solid ${s.accent}25`, borderRadius: R.xl, padding: `${S.lg}px ${S.xl}px`, boxShadow: SH.glow(s.accent), display: "flex", flexDirection: "column", justifyContent: "space-between", height: 88, boxSizing: "border-box" }}>
